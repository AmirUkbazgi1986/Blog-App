  ...
  return (
    <div className="py-5 px-5 md:px-12 lg:px-28">
      ...
      <div className="text-center my-8">
        ...
        <form
          action=""
          className="flex justify-between max-w-125 scale-75 sm:scale-100 mx-auto my-10 border border-black shadow-[-7px_7px_0px_#000000]"
        >
          <input
            type="email"
          ...
          <button
            type="submit"
            className="border-l   border-black py-4 px-4 sm:px-8 cursor-pointer active:bg-gray-600 active:text-white"
          >
            Subscribe
          </button>
        </form>
